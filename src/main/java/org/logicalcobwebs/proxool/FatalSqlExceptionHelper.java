...
class FatalSqlExceptionHelper {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FatalSqlExceptionHelper.class);
    ...
    protected static Throwable getCause(Throwable t) {
        ...
        try {
            ...
            if (causeMethod != null) {
                try {
                    cause = (Throwable) causeMethod.invoke(t, (Object[])null);
                } catch (IllegalAccessException e) {
    ...
    private static Method getMethod(Object o, String methodName) {
        Method m = null;
        try {
            m = o.getClass().getMethod(methodName, (Class<?>[])null);
